...
__all__ = ["QEffScan", "Spectrum", "Scan", "EnergyScan"]
...
class Spectrum:
    ...
    def from_h5(cls,
        ...
        **norm,
        ...
        time: int, optional
            Measurement time in seconds for normalization. Default: None.
        anode: PositionAnode, optional
            Anode object from `agepy.spec.photons`. Default:
            `DldAnodeUVW(0)`.
        target_density: str, optional
            Path to the target density in the h5 file. Default: None.
        intensity_upstream: str, optional
            Path to the upstream intensity in the h5 file. Default:
            None.
        **norm
            Additional normalization parameters as keyword arguments
